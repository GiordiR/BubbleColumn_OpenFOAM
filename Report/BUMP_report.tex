...
\begin{table}[H]
    ...
    \hline \hline
    \textbf{run001} & \textbf{Mesh A} & 20 & 200 & 4 & 0.03501 & 0.0404937\T\B \\
    \textbf{run002} &\textbf{Mesh B} & 20 & 200 & 8 & 0.03501 & 0.0411561\T\B \\
    \textbf{run003} &\textbf{Mesh C} & 40 & 200 & 8 & 0.03501 & 0.0406377\T\B \\
    \textbf{run004} &\textbf{Mesh D} & 40 & 400 & 8 & 0.03501 & 0.0407799\T\B \\
    \hline
    \end{tabular}
    \\[10pt]
    \caption{Meshes}
...
\begin{table}[H]
    ...
    \hline \hline
    \textbf{run006} & 0.0025 & 0.03501 & 0.0401548\T\B \\
    \textbf{run001} & 0.005  & 0.03501 & 0.0404937\T\B \\
    \textbf{run005} & 0.010  & 0.03501 & 0.0398255\T\B \\
    \hline
    \end{tabular}
    \\[10pt]
    \caption{Time steps}
...
\begin{table}[H]
    ...
    \hline \hline
    \textbf{run001} & kOmegaSSTSato & 0.03501 & 0.0404937\T\B \\
    \textbf{run007} & LaheyKEpsilon  & 0.03501 & 0.0388271\T\B \\
    \textbf{run008} & mixtureKEpsilon & 0.03501 & 0.039857\T\B \\
    \hline
    \end{tabular}
    \\[10pt]
...
\begin{table}[H]
    ...
    \hline \hline
    \textbf{run009} & None & 0.03501 & 0.0311115\T\B \\
    \textbf{run001} & Tomiyama & 0.03501 & 0.0404937\T\B \\
    \textbf{run010} & Moraga & 0.03501 & 0.0394963\T\B \\
    \hline
    \end{tabular}
    \\[10pt]
    \caption{Lift models}
...
\begin{table}[H]
    ...
    \hline \hline
    \textbf{run001} & None & 0.03501 & 0.0404937\T\B \\
    \textbf{run011} & Burns & 0.03501 & 0.0428537\T\B \\
    \textbf{run012} & LopezDeBertodano & 0.03501 & 0.045886\T\B \\
    \hline
    \end{tabular}
    \\[10pt]
...
\begin{table}[H]
    ...
    \hline \hline
    \textbf{run001} & None & 0.03501 &  0.0404937\T\B \\
    \textbf{run013} & Antal  & 0.03501 & 0.0401398\T\B \\
    \textbf{run014} & Frank & 0.03501 & 0.0306111\T\B \\
    \hline
    \end{tabular}
    \\[10pt]
...
\begin{table}[H]
    ...
    \hline \hline
    \textbf{run013} & 10 & 0.03501 & 0.0401398\T\B \\
    \textbf{run015} & 8  & 0.02808 & 0.0309794\T\B \\
    \textbf{run016} & 6  & 0.02042 & 0.0227286\T\B \\
    \hline
    \end{tabular}
    \\[10pt]
