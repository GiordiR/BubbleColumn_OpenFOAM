...
\begin{figure*}[!ht]
	\centering
	\includegraphics[height=8cm]{Images/test_facility2.png}
...
\subfloat{
    ...
    \textbf{Variable} & \textbf{Solver} & \textbf{Smoother} & \textbf{Tolerance}\\
     \hline \hline
     U, k, epsilon, omega  & smoothSolver & symGaussSeidel & 10$^{-7}$ \\
     p & GAMG & DIC & 10$^{-8}$\\
     \hline
    \end{tabular}%\caption{}
}\\
...
\begin{figure}[H]
    \centering
    \subfloat[h = 8 cm]{
        \includegraphics[scale=0.35, trim={0 30 0 50}, clip]{Images/graphs/mesh/surfacesJ10h8.png}
    }
    \subfloat[h = 63 cm]{
        \includegraphics[scale=0.35, trim={0 30 0 50}, clip]{Images/graphs/mesh/surfacesJ10h63.png}
    }
...
\begin{figure}[H]
    \centering
    \subfloat[h = 8 cm]{
        \includegraphics[scale=0.35, trim={0 30 0 50}, clip]{Images/graphs/time/surfacesJ10h8.png}
    }
    \subfloat[h = 63 cm]{
        \includegraphics[scale=0.35, trim={0 30 0 50}, clip]{Images/graphs/time/surfacesJ10h63.png}
    }
...
\begin{figure}[H]
    \centering
    \subfloat[h = 8 cm]{
        \includegraphics[scale=0.34, trim={0 30 0 50}, clip]{Images/graphs/turbmodel/surfacesJ10h8.png}
    }
    \subfloat[h = 63 cm]{
        \includegraphics[scale=0.34, trim={0 30 0 50}, clip]{Images/graphs/turbmodel/surfacesJ10h63.png}
    }
...
\begin{figure}[H]
    \centering
    \subfloat[h = 8 cm]{
        \includegraphics[scale=0.35, trim={0 30 0 50}, clip]{Images/graphs/lift/surfacesJ10h8.png}
    }
    \subfloat[h = 63 cm]{
        \includegraphics[scale=0.35, trim={0 30 0 50}, clip]{Images/graphs/lift/surfacesJ10h63.png}
    }
...
\begin{figure}[H]
    \centering
    \subfloat[h = 8 cm]{
        \includegraphics[scale=0.35, trim={0 30 0 50}, clip]{Images/graphs/turbdisp/surfacesJ10h8.png}
    }
    \subfloat[h = 63 cm]{
        \includegraphics[scale=0.35, trim={0 30 0 50}, clip]{Images/graphs/turbdisp/surfacesJ10h63.png}
    }
...
\begin{figure}[H]
    \centering
    \subfloat[h = 8 cm]{
        \includegraphics[scale=0.35, trim={0 30 0 50}, clip]{Images/graphs/walllub/surfacesJ10h8.png}
    }
    \subfloat[h = 63 cm]{
        \includegraphics[scale=0.35, trim={0 30 0 50}, clip]{Images/graphs/walllub/surfacesJ10h63.png}
    }
...
\begin{figure}[H]
    \centering
    \subfloat[h = 8 cm]{
        \includegraphics[scale=0.35, trim={0 30 0 50}, clip]{Images/graphs/allj/surfacesJ6h8.png}
    }
    \subfloat[h = 63 cm]{
        \includegraphics[scale=0.35, trim={0 30 0 50}, clip]{Images/graphs/allj/surfacesJ6h63.png}
    }
...
\begin{figure*}[!ht]
	\centering
	\includegraphics[width=\textwidth]{Images/air_velocity_gliphs.png}
...
\begin{figure*}[!ht]
	\centering
	\includegraphics[width=\textwidth]{Images/water_velocity_glyphs.png}
