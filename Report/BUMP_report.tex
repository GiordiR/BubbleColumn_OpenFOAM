...
\begin{sidewaystable}
    ...
    \rowcolor{bluePoli!40}
     & \thead{\textbf{$J_{in}$}} & \thead{\textbf{Mesh}} & \thead{\textbf{Time step}} &  \thead{\textbf{Turbulence model}}  & \thead{\textbf{Drag model}}  & \thead{\textbf{Lift model}} &  \thead{\textbf{Turbulent dispersion model}} & \thead{\textbf{Wall lubrication model}}\T\B \\
    \hline \hline
...
\begin{table}[H]
    ...
    \hline \hline
    \textbf{Mesh A} & 20 & 200 & 4 \T\B \\
    \textbf{Mesh B} & 20 & 200 & 8 \T\B \\
    \textbf{Mesh C} & 40 & 200 & 8 \T\B \\
    \textbf{Mesh D} & 40 & 400 & 8 \T\B \\
    \hline
    \end{tabular}
    \\[10pt]
    \caption{Meshes}
